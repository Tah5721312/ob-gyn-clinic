      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-medium text-gray-900">
                  {formatDate(patient.birthDate)} ({calculateAge(patient.birthDate)} سنة)
                </p>
              </div>
              <div>
              ...
              {patient.phone2 && (
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900">{patient.phone2}</p>
                </div>
              )}
              {patient.address && (
              ...
              {patient.maritalStatus && (
                <div>
                  ...
                  <p className="text-lg font-medium text-gray-900">{patient.maritalStatus}</p>
                </div>
              )}
              <div>
          ...
          {patient.medicalHistory && (
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold text-gray-900 mb-4">التاريخ الطبي</h2>
              <div className="space-y-4">
                {patient.medicalHistory.allergies && (
                  <div>
                    <p className="text-sm font-medium text-gray-700">الحساسيات</p>
                    <p className="text-gray-900">{patient.medicalHistory.allergies}</p>
                  </div>
                )}
                {patient.medicalHistory.chronicDiseases && (
                  <div>
                    <p className="text-sm font-medium text-gray-700">الأمراض المزمنة</p>
                    <p className="text-gray-900">{patient.medicalHistory.chronicDiseases}</p>
                  </div>
                )}
                {patient.medicalHistory.previousSurgeries && (
                  <div>
                    <p className="text-sm font-medium text-gray-700">العمليات السابقة</p>
                    <p className="text-gray-900">{patient.medicalHistory.previousSurgeries}</p>
                  </div>
                )}
                {patient.medicalHistory.familyHistory && (
                  <div>
                    <p className="text-sm font-medium text-gray-700">التاريخ العائلي</p>
                    <p className="text-gray-900">{patient.medicalHistory.familyHistory}</p>
                  </div>
                )}
              </div>
            </div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-3">
                {patient.pregnancyRecords.map((pregnancy) => (
                  <div key={pregnancy.id} className="border border-gray-200 rounded-lg p-4">
                    ...
                    {pregnancy.edd && (
                      <>
                        <p className="text-sm text-gray-600 mt-2">تاريخ الولادة المتوقع</p>
                        <p className="font-medium text-gray-900">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div className="space-y-2">
              <button
                onClick={() => router.push(`/prescriptions/new?patientId=${patient.id}`)}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              هل أنت متأكد من حذف المريض {patient.firstName} {patient.lastName}؟ لا يمكن
